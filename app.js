...
function recievedMessage(event) {
  ...
  if (message.text.toLowerCase === "Who am I?") {
    var url = 'https://graph.facebook.com/v2.6/'+ senderId +'?fields=first_name,last_name&access_token=EAAElWHwFC5UBAHUTz3tvUCIicreqS7KDknS5TaOKuZAZCSJwF5zhDE4FF2hFKTU8JGMopwLsWhhC0eKkiMJfeEqdAGfZAZAltSyHO9RXaToS6X5PsDgzGYEaHBln1ScGJT0opPyOKvIj9pZAb1N1cnpnYZAeKwdTAsGmjnuDzeeAZDZD'
    https.get(url, (res) => {
      res.on('data', (chunk) => {
